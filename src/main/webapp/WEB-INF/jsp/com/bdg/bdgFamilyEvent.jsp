...
function setInitgridView() {
    ...
    addField(cm,    'REQ_DATE',            {text:'신청일자'},        100,            'date',           {textAlignment:"center"}, {datetimeFormat: "yyyyMMdd"});
    addField(cm,    'EVNT_DATE',           {text:'경조일자'},        100,            'date',           {textAlignment:"center"}, {datetimeFormat: "yyyyMMdd"});
    ...
    gridView.onDataCellClicked = function (grid, colIndex) {
    	var gridView = grid.getDataProvider();
       	...
       	if(gridView.getValue(colIndex.itemIndex,"STATUS") == '1' && colIndex.fieldName == "CODEMAPPING2"){
       		fnSearchCustomer();
       	}       	
 ...
 function fnApply() {
	...
	if(fnSaveCheck(gridView, requiredVal) == true){
	     if(confirm("신청 하시겠습니까?")){
	    	 saveCall(gridView, '/com/bdg/applyFamilyEvent', 'fnApply', params);
	     }
	}
 }

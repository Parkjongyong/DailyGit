...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var lvlList = stringToArray("${CODELIST_YS005}");
	...
	function setInitGrid() {
	    ...
	    addField(cm,    'ITEM_CD',        {text: '품목코드'},    150,     'text', {textAlignment: "center"} ,  {editable:false});
	    addField(cm,    'ITEM_DESC',      {text: '품목명'},     120,     'text', {textAlignment: "near"}   ,  {editable:false});
	    addField(cm,    'LVL',             {text: '레벨'},           0,     'text', {textAlignment: "center"},{visible:false});
	...
	function fnSearch() {
		// 조회 요청
		searchCall(gridView, '/com/cmn/selectItemMgmtList');
	}

	//부모창에 선택값 셋팅함수 호출
	function setOpenerData(rowData) {
		parentCallback('fnCallbackItemMgmtSearchPop',rowData);
	}
		        ...
		        <table class="tbl-search">
		            ...
		            <tbody>
		                <tr>
		                    <th><span>레벨</span></th>
		                    <td>
			                    <select id="SB_LVL" name="SB_LVL">
			                    </select>
		                    </td>
		                    <td></td>
		                    <th><span>픔목명</span></th>
		                    <td>
								<input type="text" id="TB_ITEM_DESC" value="" class="w120">
		                    </td>
		                    <td></td>
		                </tr>
		            </tbody>

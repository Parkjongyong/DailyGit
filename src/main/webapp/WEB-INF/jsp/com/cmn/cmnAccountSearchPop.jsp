...
<script type="text/javascript">
	...
	function setInitGrid() {
	    ...
	    addField(cm,    'ACCOUNT_NO',        {text: '계정코드'},    70,     'text', {textAlignment: "center"} ,  {editable:false});
	    addField(cm,    'ACCOUNT_DESC',      	{text: '계정명'},     120,     'text', {textAlignment: "near"}   ,  {editable:false});
	    addField(cm,    'W_CODE',            	{text: '위탁연구비코드'},     120,     'text', {textAlignment: "near"}   ,  {visible:false});
	...
	function fnSearch() {
		// 조회 요청
		searchCall(gridView, '/com/cmn/selectAccountList');
	}

	//부모창에 선택값 셋팅함수 호출
	function setOpenerData(rowData) {
		parentCallback('fnCallbackAccountSearchPop',rowData);
	}
		...
		<div class="tbl-search-wrap">
		    <div class="tbl-search-area">
		        <table class="tbl-search">
		            ...
		            <tbody>
		                <tr>
		                    <th><span>계정코드</span></th>
		                    <td>
								<input type="text" id="TB_ACCOUNT_NO" value="" class="w100">
		                    </td>
		                    <td></td>
		                    <th><span>계정명</span></th>
		                    <td>
								<input type="text" id="TB_ACCOUNT_DESC" value="" class="w120">
								<input type="hidden" id="TB_ACCOUNT_GUBN" value="${PARAM.ACCOUNT_GUBN}">

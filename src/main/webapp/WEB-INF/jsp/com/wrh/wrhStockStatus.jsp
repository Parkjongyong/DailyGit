...
function setInitGridView() {
    ...
    addField(cm,    'PO_ORG_NM',         {text: '구매그룹'},      60,     'text',     {textAlignment: "center"});
    ...
    addField(cm,    'H_ITEM_QTY',        {text: '입고수량'},           0,     'text',     {textAlignment: "center"}, {visible:false});
    addField(cm,    'H_GR_AMT',          {text: '입고금액'},           0,     'text',     {textAlignment: "center"}, {visible:false});
...
function fnSearchSuccess(data) {
	if(isEmpty(data.rows)){
		...
		if (isNotEmpty(data.fields.result.TOT_GR_AMT)) {
			$('#TB_TOT_GR_AMT').val(data.fields.result.TOT_GR_AMT);
		}
	}
	// 에러메세지 처리
	alertErrMsg(data);
        ...
        <table class="tbl-search">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
						<input class="w120" type="text" id="TB_MAT_NUMBER" value=""/>
                    </td>

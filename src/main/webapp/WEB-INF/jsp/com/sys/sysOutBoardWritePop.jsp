<%--
	File Name : sysOutBoardWritePop.jsp
	Description: 공지사항 글쓰기 화면
...
function fnSave() {
	...
	if (fnValidate() ) {
	    if(confirm("저장 하시겠습니까?")) {
			...
			// 조회 요청
			deleteCall(null, '/com/sys/insertBoard', 'fnSave', params);    
	    }
	}
}
        ...
        <c:choose>
            ...
            <li>
                <dl class="vos-write">
                    <dt>제목</dt>
                    <dd>
                        <input type="text" id="subject" name="subject" class="wp100" maxlength="100">
                    </dd>
                </dl>
            </li>
            <li>

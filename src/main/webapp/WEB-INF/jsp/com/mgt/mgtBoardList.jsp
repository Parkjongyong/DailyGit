...
function initGridView() {
    ...
    addField(cm ,   'STATUS_NM',  {text: '게시여부'},               60,     'text');
...
var fnWrite = function() {
    var params = fnParams();
    fnPostGoto("<c:url value='/com/mgt/mgtBoardWrite.do'/>", params, "_self");
};
...
<div class="cont-tit">
    <div class="right">
        <button type="button" class="btn st1" id="btnWrite">글쓰기</button>
    </div>
</div>
</c:if>

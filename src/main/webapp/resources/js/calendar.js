        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    ...
                    children.push(createElement("h6", { className: 'fc-toolbar-sub' }, "※ 창고전체 PLT 수(현재누적 PLT 수)"));
                }
                else {
    ...
    function renderInnerContent(innerProps) {
        return (createElement("div", { className: 'fc-event-main-frame' },
            ...
            createElement("div", { className: 'fc-event-title-container' },
                createElement("td", { className: 'fc-event-title fc-sticky', id: 'TB-' + innerProps.event.startStr}, innerProps.event.title || createElement(Fragment, null, "\u00A0")),
                (innerProps.event._def.extendedProps.cnt == "0" ? createElement("td", { className: 'fc-event-title fc-sticky'}) : createElement("td", { className: 'fc-event-title fc-calendar-img', id: 'IG-' + innerProps.event.startStr}))
                )));
    }

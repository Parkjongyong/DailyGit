...
import com.app.ildong.bat.service.BatHRBugtInterfaceService;
...
@Controller
public class makeHRBugtInterfaceController extends BaseJobBean {
	...
	@Autowired
	private BatHRBugtInterfaceService batHRBugtInterfaceService;	
	...
	private String _BATCH_JOB_ID	= "MAKE_HR_BUGT_IF";
	...
	public void makeHRBugtInterfaceJobRun(LinkedHashMap<String, Object> serviceParams) throws Exception {
		String compCd		= "";
		String runIp		= "";
		...
		if (goBatchRun) {
			...
			try {
				...
				batHRBugtInterfaceService.makeInterfaceHRBugtData(paramInfo);

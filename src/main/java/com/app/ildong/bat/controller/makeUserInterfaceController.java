...
import com.app.ildong.bat.service.BatUserInterfaceService;
import com.app.ildong.common.exception.ServiceException;
import com.app.ildong.common.model.mvc.BaseJobBean;
import com.app.ildong.common.service.CommonSelectService;

@Controller
public class makeUserInterfaceController extends BaseJobBean {
	...
	@Autowired
	private BatUserInterfaceService batUserInterfaceService;	
	...
	private String _BATCH_JOB_ID	= "MAKE_USER_IF";
	...
	public void makeUserInterfaceJobRun(LinkedHashMap<String, Object> serviceParams) throws Exception {
		String compCd		= "";
		String runIp		= "";
		...
		if (goBatchRun) {
			...
			try {
				...
				// 1. 부서 정보 추출(인사정보-타시스템) 
				batUserInterfaceService.makeInterfaceUserData(paramInfo);

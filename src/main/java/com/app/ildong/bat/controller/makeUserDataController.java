...
import com.app.ildong.bat.service.BatUserService;
import com.app.ildong.common.exception.ServiceException;
import com.app.ildong.common.model.mvc.BaseJobBean;
import com.app.ildong.common.service.CommonSelectService;

@Controller
public class makeUserDataController extends BaseJobBean {
	...
	@Autowired
	private BatUserService batUserService;	
	...
	private String _BATCH_JOB_ID	= "MAKE_USER_DATA";
	...
	public void makeUserDataJobRun(LinkedHashMap<String, Object> serviceParams) throws Exception {
		String compCd		= "";
		String runIp		= "";
		...
		if (goBatchRun) {
			...
			try {
				...
				// 1. 인사 정보 생성(인사정보-타시스템) 
				batUserService.makeUserData(paramInfo);

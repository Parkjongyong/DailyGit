...
@Controller
public class BatMakeReportDataController extends BaseJobBean {
	...
	private String _BATCH_JOB_ID	= "MAKE_REPORT_DATA";
	...
	public void makeReportDataJobRun(LinkedHashMap<String, Object> serviceParams) throws Exception {
		String compCd		= "";
		String runIp		= "";
		...
		try {
			...
			System.out.println("BATCH_ARG1::::::" + paramInfo.get("BATCH_ARG1"));
			System.out.println("BATCH_ARG2::::::" + paramInfo.get("BATCH_ARG2"));
			System.out.println("BATCH_ARG3::::::" + paramInfo.get("BATCH_ARG3"));
		...
		if (goBatchRun) {
			...
			try {
				...
				// 1. 대시보트 리포팅 처리 프로시저 호출 
				//batchResult = sapInterfaceService.makeReportDataProcess(paramMap);
				batchResult.put("RESULT", "S");
				batchResult.put("ERR_MSG", "");
				
				if (!"S".equals((String)batchResult.get("RESULT")) && !"C".equals((String)batchResult.get("RESULT"))) {
					batchSucc = false;

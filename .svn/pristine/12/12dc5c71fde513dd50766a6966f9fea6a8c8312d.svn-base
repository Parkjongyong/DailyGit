...
import com.app.ildong.bat.service.BatDeptService;
...
@Controller
public class makeDeptDataController extends BaseJobBean {
	...
	@Autowired
	private BatDeptService batDeptService;	
	...
	private String _BATCH_JOB_ID	= "MAKE_DEPT_DATA";
	...
	public void makeDeptDataJobRun(LinkedHashMap<String, Object> serviceParams) throws Exception {
		String compCd		= "";
		String runIp		= "";
		...
		if (goBatchRun) {
			...
			try {
				...
				batDeptService.makeInterfaceDeptData(paramInfo);

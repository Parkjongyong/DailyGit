...
import com.app.ildong.bat.service.BatHRVacatInterfaceService;
...
@Controller
public class makeHRVacatInterfaceController extends BaseJobBean {
	...
	@Autowired
	private BatHRVacatInterfaceService batHRVacatInterfaceService;	
	...
	private String _BATCH_JOB_ID	= "MAKE_HR_VACAT_IF";
	...
	public void makeHRVacatInterfaceJobRun(LinkedHashMap<String, Object> serviceParams) throws Exception {
		String compCd		= "";
		String runIp		= "";
		...
		if (goBatchRun) {
			...
			try {
				...
				// 1. HR인건비 정보 추출(인사정보-타시스템) 
				batHRVacatInterfaceService.makeInterfaceHRVacatData(paramInfo);
